...
https://github.com/PINTO0309/PINTO_model_zoo/blob/main/149_depth_estimation
'''
...
detection_nn.setBlobPath("../Models/blob/mask_openvino_2022.1_6shave.blob")
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        # Get output layer
        f_4 = np.array(in_nn.getFirstLayerFp16()).reshape((NN_HEIGHT, NN_WIDTH))
        cv2.imshow("pred",f_4)
        # f_4.data.squeeze(0).cpu()
